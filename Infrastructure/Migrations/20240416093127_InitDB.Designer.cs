...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20240416093127_InitDB")]
            ...
            modelBuilder.Entity("Infrastructure.Entities.CoursesEntity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1163),
                            ...
                            Updated = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1168),
                            ViewHours = "220",
                        ...
                        new
                        {
                            ...
                            Created = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1188),
                            IsBestSeller = false,
                            LikesInNumbers = "3.1",
                            LikesInPercent = "92",
                            Price = "15.99",
                            Title = "HTML, CSS, JavaScript Web Developer",
                            Updated = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1189),
                            ViewHours = "160"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1191),
                            DiscountPrice = "9.99",
                            IsBestSeller = false,
                            LikesInNumbers = "2.7",
                            LikesInPercent = "98",
                            ...
                            Updated = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1191),
                            ViewHours = "100"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1193),
                            IsBestSeller = false,
                            LikesInNumbers = "3.1",
                            LikesInPercent = "92",
                            Price = "15.99",
                            Title = "iOS & Swift - The Complete iOS App Development Course",
                            Updated = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1193),
                            ViewHours = "220"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1195),
                            IsBestSeller = true,
                            LikesInNumbers = "4.2",
                            LikesInPercent = "94",
                            Price = "12.50",
                            Title = "Data Science & Machine Learning with Python",
                            Updated = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1195),
                            ViewHours = "220"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1197),
                            IsBestSeller = false,
                            LikesInNumbers = "4.2",
                            LikesInPercent = "94",
                            Price = "10.50",
                            Title = "Creative CSS Drawing Course: Make Art With CSS",
                            Updated = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1197),
                            ViewHours = "220"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1199),
                            IsBestSeller = false,
                            LikesInNumbers = "3.1",
                            LikesInPercent = "92",
                            Price = "18.99",
                            Title = "Blender Character Creator v2.0 for Video Games Design",
                            Updated = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1200),
                            ViewHours = "160"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1201),
                            DiscountPrice = "12.99",
                            IsBestSeller = false,
                            LikesInNumbers = "2.7",
                            LikesInPercent = "98",
                            ...
                            Updated = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1201),
                            ViewHours = "100"
                        },
                        new
                        {
                            ...
                            Created = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1203),
                            IsBestSeller = false,
                            LikesInNumbers = "3.1",
                            LikesInPercent = "92",
                            Price = "14.50",
                            Title = "Learn JMETER from Scratch on Live Apps-Performance Testing",
                            Updated = new DateTime(2024, 4, 16, 9, 31, 27, 192, DateTimeKind.Utc).AddTicks(1203),
                            ViewHours = "160"
                        });
                });
